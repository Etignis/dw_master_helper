					...
					data: {
						...
						list: {
							data: [
								...
								"Вы выходите из дверей поместья Герцога, который поручил вам крафне секретное задание и выдал значительное вознаграждение загодя. За закрывающимися дверьми слышите крики \"Герцог мертв! Это убийство!\" и приближающийся топот.",
