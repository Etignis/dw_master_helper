	...
	
	{
		...
		sub: [			
			...
			},
			{
				...
				ico: "",
				data: {
					pre: "Бросайте кубика урона монстра, добавьте +d4 к броску, если монстр властвует над другими или древний. Если монстр запасливый, бросьте кубик дважды, возьмите лучший результат:",
					list: {
						bShuffle: false,
						data: [
